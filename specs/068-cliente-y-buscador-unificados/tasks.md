...
- [x] **T007** Filtro de la carta online sobre `show_online`, persistido por máquina + superficie (`useStickyFilter`, spec 065). Sólo se muestra si el catálogo tiene de los dos tipos.
- [x] **T007b** Fast-follow (feedback de Juan, 2026-07-30): las etiquetas pasan a **«En la carta online» / «Solo para el local»** —el vocabulario del form del producto— y se suma una explicación al pie que aparece sólo con un filtro puesto. «Va a la web / No va» no se entendía.
...
- [ ] **T012** Verify en vivo con rol real: abrir mesa (foco en cliente, Enter abre), nueva reserva (foco en cliente, Enter crea, Enter con resultado marcado elige), y el filtro de la carta online en las tres pantallas de carga.
