        ...
        >
          ...
          <div className="flex items-start justify-between gap-3 px-5">
            <div className="min-w-0">
              <h3 className="font-heading text-lg leading-tight font-bold text-zinc-900">
                {product.name}
              </h3>
              {product.description && (
          ...
          <div className="mt-5 space-y-1 px-5">
            <label className="block text-xs font-bold tracking-wide text-zinc-700 uppercase">
              Observaciones
            </label>
            {permiteComoEntrada && (
              <button
            ...
            <textarea
              ...
              className="block w-full rounded-2xl border border-zinc-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 focus:outline-none"
              rows={2}
            />
          ...
          <div className="mx-5 mt-4 flex items-center justify-between rounded-2xl bg-zinc-50 p-2 ring-1 ring-zinc-100">
            <span className="px-2 text-sm font-semibold text-zinc-700">
              Cantidad
            </span>
